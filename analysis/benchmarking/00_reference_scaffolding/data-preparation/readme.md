...
- Zika virus
- West Nile virus
- Human immunodeficiency virus 1 (+ 41 complete genomes of HIV-2)
- Monkeypox virus
- Influenza A virus
...
Downloaded either all sequences (complete genomes) or a random subset of 2000 sequences (if more than 2k available). Downloaded in FASTA format with Accession, GenBank, Segment headers.
